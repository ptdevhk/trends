...
HR feedback patterns and observations. Compacted on 2026-03-10 from 174 raw shortlist entries into 50 unique patterns. Frequency-weighted `shortlist_pattern` entries below remain machine-readable; the `(Nx)` suffix is consumed as signal strength.
