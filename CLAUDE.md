...
- Default/basic model for all daily agent tasks and basic services: `openai/deepseek-v4-flash` (Poe gateway `AI_API_BASE=https://api.poe.com/v1`). Historical ADR still at `{WIKI_VAULT}/projects/trends/architecture/decisions/2026-08-13-deepseek-v4-flash-default-model.md` — operational default swapped 2026-08-17 after live probe, then re-promoted 2026-08-25 after the Poe `response_format` bug was confirmed fixed.
