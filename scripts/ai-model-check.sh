...
KNOWN_MODELS="gpt-4o-mini gpt-4o gpt-4-turbo gpt-4 gpt-3.5-turbo openai/gpt-4o-mini openai/gpt-4o openai/gpt-4-turbo-preview deepseek/deepseek-chat deepseek/deepseek-reasoner deepseek-v4-flash openai/deepseek-v4-flash deepseek-v4-flash-e openai/deepseek-v4-flash-e"
if [ -n "$MODEL" ]; then
  STRIPPED="${MODEL#*/}"
