...
help:
	...
	@echo "  CONVEX_MIRROR_MODE Prefetch source order for install/deploy: off|fallback|mirror-first"
	@echo "  CONVEX_MIRROR_BASES / CONVEX_DOWNLOAD_TIMEOUT_SECS / CONVEX_CONNECT_TIMEOUT_SECS"
	@echo "                 Install/deploy Convex prefetch mirror-base and timeout overrides"
	@echo "  CONVEX_CURL_NO_SILENT Set true/1 to keep install/deploy Convex prefetch curl progress output enabled"
