...
test-coverage:                             ## Run Node.js tests with coverage
	...
	@npx vitest run --coverage apps/api/src packages/convex/convex packages/shared/src scripts/extension-zip-integrity.test.ts scripts/industry-data/my-cnc-catalog-seed.test.ts scripts/install-deploy-safety.test.ts
