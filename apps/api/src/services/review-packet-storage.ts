...
import type { ExportBatchMeta, ResumeExportEntry } from "./export-service.js";
import type { IndustryDbV2BatchStats } from "./industry-db-batch-stats.js";
...
export type ReviewPacketRunContext = {
  exportEntries?: ResumeExportEntry[];
...
export type StoredReviewPacketRun = {
  ...
  context?: ReviewPacketRunContext;
  error?: string;
};
...
function normalizeRun(row: Record<string, unknown>): StoredReviewPacketRun {
  ...
  return {
    ...
    context: parseJsonObject<ReviewPacketRunContext>(row.context_json),
