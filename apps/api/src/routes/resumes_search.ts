...
import { RuleScoringService, type BrandContext, type BrandHit, type BrandRole, type RoleSignalSummary, type RuleScoringContext, type RuleScoringResult } from "../services/rule-scoring.js";
...
function resolveResumeSortOrder(
