    ...
    brandHits: [
        {
            ...
            role: "both" as const,
            source: "workHistory",
            context: "equipment" as const,
            companyId: 123,
            origin: "international" as const,
            productClass: "complete_machine" as const,
        },
    ],
    ...
    describe("BFF IngestResult → Convex validator compatibility", () => {
        ...
        it("ingestDataValidator accepts a realistic BFF IngestResult payload", () => {
            ...
            const mappedIngestData = {
                ...
                brandOrigin: BFF_INGEST_RESULT_FIXTURE.brandOrigin,
                productClass: BFF_INGEST_RESULT_FIXTURE.productClass,
