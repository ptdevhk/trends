...
export const MUTATIONS_REGISTRY: MutationRegistryEntry[] = [
    ...
    { file: "company-registry.ts", name: "upsert", quiesceAware: true, reason: "Blocked by BFF middleware" },
    { file: "company-registry.ts", name: "setCompanyArchived", quiesceAware: true, reason: "Blocked by BFF middleware" },
    { file: "company-registry.ts", name: "addAlias", quiesceAware: true, reason: "Blocked by BFF middleware" },
    { file: "company-registry.ts", name: "removeAlias", quiesceAware: true, reason: "Blocked by BFF middleware" },
    { file: "company-registry.ts", name: "appendPolicyRevision", quiesceAware: true, reason: "Blocked by BFF middleware" },
    { file: "company-resume-links.ts", name: "backfillCompanyResumeLinks", quiesceAware: true, reason: "Admin industry-link backfill via write-secret and BFF maintenance guard" },
    { file: "company-registry.ts", name: "seedCanonicalCompanies", quiesceAware: true, reason: "Blocked by BFF middleware" },
    { file: "industry-profiles.ts", name: "upsertIndustryProfile", quiesceAware: true, reason: "Admin industry-evidence stewardship via write-secret and BFF middleware" },
    { file: "industry-profiles.ts", name: "deleteIndustryProfile", quiesceAware: true, reason: "Admin industry-evidence stewardship via write-secret and BFF middleware" },
    { file: "industry-proposals.ts", name: "upsertIndustryProposal", quiesceAware: true, reason: "Industry maintenance proposal write via write-secret and BFF middleware" },
    { file: "industry-proposals.ts", name: "recordIndustryRefreshRequest", quiesceAware: true, reason: "Authenticated workspace refresh request ledger via write-secret and BFF maintenance guard" },
    { file: "industry-proposals.ts", name: "setIndustryProposalResearchState", quiesceAware: true, reason: "Industry maintenance worker state via write-secret and BFF maintenance guard" },
    { file: "industry-evidence-sources.ts", name: "upsertIndustryEvidenceSource", quiesceAware: true, reason: "Industry evidence write via write-secret and BFF/worker maintenance guard" },
    { file: "industry-evidence-sources.ts", name: "markIndustryEvidenceProfilesChecking", quiesceAware: true, reason: "Industry freshness maintenance via write-secret and BFF/worker maintenance guard" },
    { file: "industry-evidence-sources.ts", name: "recordIndustryEvidenceFreshnessCheck", quiesceAware: true, reason: "Industry freshness maintenance via write-secret and BFF/worker maintenance guard" },
    { file: "industry-verdicts.ts", name: "approveIndustryProposal", quiesceAware: true, reason: "Attended admin approval via write-secret and BFF middleware" },
    { file: "industry-verdicts.ts", name: "autoApproveIndustryProposal", quiesceAware: true, reason: "Governed Lane A auto-verify via write-secret and BFF/script maintenance guard" },
    { file: "industry-verdicts.ts", name: "resolveIndustryProposal", quiesceAware: true, reason: "Attended admin review via write-secret and BFF middleware" },
    { file: "industry-identity.ts", name: "deleteIndustryIdentityCandidates", quiesceAware: true, reason: "Admin junk-candidate prune via write-secret and BFF/script maintenance guard" },
    { file: "industry-coverage.ts", name: "refreshIndustryCoverageProposalCounters", quiesceAware: true, reason: "Precomputed coverage counters refresh (proposal scan) via write-secret and BFF maintenance guard" },
    { file: "industry-coverage.ts", name: "refreshIndustryCoverageEvidenceCounters", quiesceAware: true, reason: "Precomputed coverage counters refresh (evidence scan) via write-secret and BFF maintenance guard" },
    { file: "industry-recompute.ts", name: "startIndustryRecomputeRun", quiesceAware: true, reason: "Targeted exact reingest orchestration via write-secret and BFF middleware" },
    { file: "industry-recompute.ts", name: "reserveIndustryRecomputePage", quiesceAware: true, reason: "Targeted exact reingest orchestration via write-secret and BFF middleware" },
    { file: "industry-recompute.ts", name: "recordIndustryRecomputeBatchDispatch", quiesceAware: true, reason: "Targeted exact reingest orchestration via write-secret and BFF middleware" },
    { file: "industry-recompute.ts", name: "recordIndustryRecomputeBatchFailure", quiesceAware: true, reason: "Targeted exact reingest orchestration via write-secret and BFF middleware" },
    { file: "industry-recompute.ts", name: "recordIndustryRecomputeBatchReadiness", quiesceAware: true, reason: "Targeted exact reingest orchestration via write-secret and BFF middleware" },
    { file: "industry-recompute.ts", name: "finalizeIndustryRecomputeRun", quiesceAware: true, reason: "Targeted exact reingest orchestration via write-secret and BFF middleware" },
    { file: "industry-recompute.ts", name: "markIndustryRecomputeRunSuperseded", quiesceAware: true, reason: "Targeted exact reingest orchestration via write-secret and BFF middleware" },
    { file: "industry-recompute.ts", name: "retryIndustryRecomputeRun", quiesceAware: true, reason: "Attended targeted recompute retry via write-secret and BFF middleware" },
    ...
    { file: "industry-verdicts.ts", name: "undoIndustryProposalApproval", quiesceAware: true, reason: "Attended admin undo via write-secret and BFF middleware" },
    { file: "industry-research-requests.ts", name: "enqueueIndustryEvidenceResearchRequest", quiesceAware: true, reason: "Industry research queue write via write-secret and maintenance middleware" },
    { file: "industry-research-requests.ts", name: "enqueueScheduledIndustryEvidenceResearchSweep", quiesceAware: true, reason: "Scheduled research queue write via write-secret and worker maintenance guard" },
    { file: "industry-research-requests.ts", name: "claimIndustryEvidenceResearchRequests", quiesceAware: true, reason: "Worker research lease claim via write-secret and maintenance guard" },
    { file: "industry-research-requests.ts", name: "startAndClaimIndustryEvidenceMaintenanceRun", quiesceAware: true, reason: "Industry maintenance orchestration via write-secret and worker maintenance guard" },
    { file: "industry-research-requests.ts", name: "renewIndustryEvidenceResearchRequestLease", quiesceAware: true, reason: "Worker research lease renewal via write-secret and maintenance guard" },
    { file: "industry-research-requests.ts", name: "completeIndustryEvidenceResearchRequest", quiesceAware: true, reason: "Worker research completion via write-secret and maintenance guard" },
    { file: "industry-research-requests.ts", name: "releaseIndustryEvidenceResearchRequests", quiesceAware: true, reason: "Worker research lease release via write-secret and maintenance guard" },
    { file: "industry-research-requests.ts", name: "recoverExpiredIndustryEvidenceResearchLeases", quiesceAware: true, reason: "Worker research lease recovery via write-secret and maintenance guard" },
    { file: "industry-research-requests.ts", name: "retryIndustryEvidenceResearchRequest", quiesceAware: true, reason: "Attended research retry via write-secret and maintenance middleware" },
    { file: "industry-research-requests.ts", name: "cancelIndustryEvidenceResearchRequest", quiesceAware: true, reason: "Attended research cancellation via write-secret and maintenance middleware" },
    { file: "industry-identity.ts", name: "upsertIndustryIdentityCandidate", quiesceAware: true, reason: "Identity candidate write via write-secret and maintenance middleware" },
    { file: "industry-identity.ts", name: "resolveIndustryProposalIdentity", quiesceAware: true, reason: "Attended identity resolution via write-secret and maintenance middleware" },
    { file: "industry-identity.ts", name: "attachProposalToCompany", quiesceAware: true, reason: "Attended proposal attachment via write-secret and maintenance middleware" },
    { file: "industry-maintenance-runs.ts", name: "startIndustryMaintenanceRun", quiesceAware: true, reason: "Industry maintenance orchestration via write-secret and maintenance middleware" },
    { file: "industry-maintenance-runs.ts", name: "claimNextIndustryMaintenanceRun", quiesceAware: true, reason: "Worker maintenance claim via write-secret and maintenance guard" },
    { file: "industry-maintenance-runs.ts", name: "patchIndustryMaintenanceRunContext", quiesceAware: true, reason: "Industry maintenance ledger context via write-secret and maintenance guard" },
    { file: "industry-maintenance-runs.ts", name: "appendIndustryMaintenanceLedger", quiesceAware: true, reason: "Industry maintenance ledger write via write-secret and maintenance guard" },
    { file: "industry-maintenance-runs.ts", name: "finishIndustryMaintenanceRun", quiesceAware: true, reason: "Worker maintenance completion via write-secret and maintenance guard" },
    { file: "industry-data-entries.ts", name: "upsertIndustryDataEntry", quiesceAware: true, reason: "Admin industry data write via write-secret and BFF middleware" },
    { file: "industry-data-entries.ts", name: "deleteIndustryDataEntry", quiesceAware: true, reason: "Admin industry data delete via write-secret and BFF middleware" },
    { file: "industry-data-entries.ts", name: "appendIndustryDataChange", quiesceAware: true, reason: "Admin industry data audit write via write-secret and BFF middleware" },
    { file: "industry-data-entries.ts", name: "setIndustryDataChangeGitSha", quiesceAware: true, reason: "Admin industry data audit annotation via write-secret and BFF middleware" },
    { file: "industry-data-entries.ts", name: "setIndustryMaintenanceSchedulePaused", quiesceAware: true, reason: "Admin maintenance schedule control via write-secret and BFF middleware" },
