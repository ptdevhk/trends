...
export const MUTATIONS_REGISTRY: MutationRegistryEntry[] = [
    ...
    { file: "companies.ts", name: "backfillCompanyResumeLinks", quiesceAware: true, reason: "Admin industry-link backfill via write-secret and BFF maintenance guard" },
    ...
    { file: "companies.ts", name: "deleteIndustryIdentityCandidates", quiesceAware: true, reason: "Admin junk-candidate prune via write-secret and BFF/script maintenance guard" },
    { file: "companies.ts", name: "refreshIndustryCoverageProposalCounters", quiesceAware: true, reason: "Precomputed coverage counters refresh (proposal scan) via write-secret and BFF maintenance guard" },
    { file: "companies.ts", name: "refreshIndustryCoverageEvidenceCounters", quiesceAware: true, reason: "Precomputed coverage counters refresh (evidence scan) via write-secret and BFF maintenance guard" },
